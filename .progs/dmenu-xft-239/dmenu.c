...
setup(Bool bottom) {
    ...
    XftColorAllocName(dpy,DefaultVisual(dpy,screen),DefaultColormap(dpy,screen),selfg, dc.xftsel);
    XftColorAllocName(dpy,DefaultVisual(dpy,screen),DefaultColormap(dpy,screen),normfg, dc.xftnorm);
	...
	mh = dc.font.extents->y+dc.font.extents->height;
    ...
    //dc.xftdrawable = malloc(sizeof(XftDraw));
