...
-- resize windows with the keyboard
    ...
    awful.key({ "Mod1", "Shift" }, "k",
        function () awful.client.moveresize(0, 0, 0, -mspeed) end),
    awful.key({ "Mod1", "Shift" }, "h",
        function () awful.client.moveresize(0, 0, -mspeed, 0) end),
    awful.key({ "Mod1", "Shift" }, "l",
        function () awful.client.moveresize(-0, 0, mspeed, 0) end),
...
awful.rules.rules = {
    ...
    { rule = { class = "mpv" }, properties = { tag = tags[1][5], floating = true } },
    { rule = { class = "pinentry" },
      properties = { floating = true } },
    { rule = { class = "gimp" },
      properties = { floating = true } },
    ...
    { rule =  { class = "Geeqie", name ="Geeqie" }, properties = { tag = tags[1][6], floating = false }},
    { rule =  { class = "Geeqie", name = "Full screen - Geeqie" }, properties = { tag = tags[1][6], floating = true }},
    ...
    { rule =  { class = "dgen" }, properties = { tag = tags[1][7], floating = false }},
    ...
    { rule =  { class = "libreoffice"}, properties = { tag = tags[1][9], floating = false }},
    { rule =  { name = ".*LibreOffice.*"}, properties = { tag = tags[1][9], floating = false }},
    ...
    { rule =  { class = "Stardict", name = "StarDict" }, properties = { tag = tags[1][4],  floating = false }},
